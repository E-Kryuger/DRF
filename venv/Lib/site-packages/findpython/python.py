...
class PythonVersion:
    ...
    def matches(
        ...
        if architecture is not None and self.architecture != architecture:
            return False
        if implementation is not None and self.implementation.lower() != implementation.lower():
            return False
        return True
    ...
    def __repr__(self) -> str:
        ...
        return "<PythonVersion {}>".format(", ".join(f"{attr}={getattr(self, attr)!r}" for attr in attrs))
    ...
    def _get_version(self) -> Version:
        ...
        version = _run_script(str(self.executable), script, timeout=GET_VERSION_TIMEOUT).strip()
