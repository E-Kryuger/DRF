...
_BaseGetWindowsDirectory = function_factory(dlls.kernel32.GetWindowsDirectoryW, [LPWSTR, UINT], UINT, check_zero)

_BaseGetSystemDirectory = function_factory(dlls.kernel32.GetSystemDirectoryW, [LPWSTR, UINT], UINT, check_zero)
