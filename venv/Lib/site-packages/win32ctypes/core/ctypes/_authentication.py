        ...
        for key in SUPPORTED_CREDKEYS:
            if key in credential:
                if key != "CredentialBlob":
                    ...
                    c_creds.CredentialBlobSize = ctypes.sizeof(blob_data) - ctypes.sizeof(ctypes.c_wchar)
...
_CredWrite = function_factory(dlls.advapi32.CredWriteW, [PCREDENTIAL, DWORD], BOOL, check_false_factory("CredWrite"))

_CredRead = function_factory(
    dlls.advapi32.CredReadW, [LPCWSTR, DWORD, DWORD, PPCREDENTIAL], BOOL, check_false_factory("CredRead")
)
