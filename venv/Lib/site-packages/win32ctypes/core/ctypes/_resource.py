...
_SizeofResource = function_factory(dlls.kernel32.SizeofResource, [HMODULE, HRSRC], DWORD, check_zero)

_BeginUpdateResource = function_factory(dlls.kernel32.BeginUpdateResourceW, [LPCWSTR, BOOL], HANDLE, check_null)

_EndUpdateResource = function_factory(dlls.kernel32.EndUpdateResourceW, [HANDLE, BOOL], BOOL, check_false)

_BaseEnumResourceNames = function_factory(
    dlls.kernel32.EnumResourceNamesW, [HMODULE, LPCWSTR, _ENUMRESNAMEPROC, LONG_PTR], BOOL, check_false
)

_BaseEnumResourceLanguages = function_factory(
    dlls.kernel32.EnumResourceLanguagesW, [HMODULE, LPCWSTR, LPCWSTR, _ENUMRESLANGPROC, LONG_PTR], BOOL, check_false
)
...
_BaseUpdateResource = function_factory(
    dlls.kernel32.UpdateResourceW, [HANDLE, LPCWSTR, LPCWSTR, WORD, LPVOID, DWORD], BOOL, check_false
)
