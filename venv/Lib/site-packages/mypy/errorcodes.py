...
TYPEDDICT_READONLY_MUTATED = ErrorCode("typeddict-readonly-mutated", "TypedDict's ReadOnly key is mutated", "General")
...
EXPLICIT_ANY: Final = ErrorCode("explicit-any", "Warn about explicit Any type annotations", "General")
