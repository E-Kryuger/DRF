...
class Repo(BaseRepo):
    ...
    def _write_reflog(self, ref, old_sha, new_sha, committer, timestamp, timezone, message) -> None:
    ...
    def stage(
        ...
        for fs_path in fs_paths:
            ...
            if os.path.isabs(fs_path):
                raise ValueError(f"path {fs_path!r} should be relative to " "repository root, not absolute")
