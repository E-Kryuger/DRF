...
BUILD_SYSTEM_MIN_VERSION: str | None = Version.from_parts(
    ...
    patch=poetry_core_version.patch if (poetry_core_version.major, poetry_core_version.minor) == (0, 0) else 0,
).to_string()
...
class Layout:
    ...
    def create(self, path: Path, with_tests: bool = True, with_pyproject: bool = True) -> None:
