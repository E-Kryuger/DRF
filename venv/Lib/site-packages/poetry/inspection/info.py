...
class PackageInfo:
    ...
    def to_package(self, name: str | None = None, root_dir: Path | None = None) -> Package:
        """
    ...
    def _requirements_from_distribution(
        ...
        if dist.metadata_version is not None:
            ...
            if metadata_version >= DYNAMIC_METADATA_VERSION and "Requires-Dist" not in dist.dynamic:
                return []
