...
class RepositoryPool(AbstractRepository):
    ...
    def add_repository(self, repository: Repository, *, priority: Priority = Priority.PRIMARY) -> RepositoryPool:
        """
    ...
    def package(self, name: str, version: Version, repository_name: str | None = None) -> Package:
        if repository_name:
