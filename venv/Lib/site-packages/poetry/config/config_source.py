...
class ConfigSourceMigration:
    ...
    def dry_run(self, config_source: ConfigSource, io: IO | None = None) -> bool:
        ...
        new_value = self.value_migration[old_value] if self.value_migration else old_value
...
def drop_empty_config_category(keys: list[str], config: dict[Any, Any]) -> dict[Any, Any]:
    config_ = {}
