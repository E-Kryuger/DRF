...
class Package(PackageSpecification):
    ...
    def all_requires(self) -> list[Dependency]:
        ...
        """
        return [
            dependency for group in self._dependency_groups.values() for dependency in group.dependencies_for_locking
        ]
    ...
    def _set_version(self, version: str | Version) -> None:
        ...
        if not isinstance(version, Version):
            try:
                ...
                raise InvalidVersionError(f"Invalid version '{version}' on package {self.name}")
    ...
    def python_marker(self) -> BaseMarker:
        ...
        return parse_marker(create_nested_marker("python_version", self._python_constraint))
