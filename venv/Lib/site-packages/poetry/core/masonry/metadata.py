...
class Metadata:
    ...
    def from_package(cls, package: ProjectPackage) -> Metadata:
        ...
        meta.requires_dist = [d.to_pep_508() for d in package.requires if not d.is_optional() or d.in_extras]
        ...
        meta.project_urls = tuple(f"{name}, {url}" for name, url in package.urls.items())
