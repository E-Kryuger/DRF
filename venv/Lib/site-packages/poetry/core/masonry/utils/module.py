...
class Module:
    def __init__(
        ...
        if not packages:
            ...
            if pkg_dir.is_dir() and py_file.is_file():
                ...
                if src_pkg_dir.is_dir() and src_py_file.is_file():
                    ...
                    raise ModuleOrPackageNotFoundError(f"No file/folder found for package {name}")
        ...
        for include in includes:
            self._explicit_includes.append(Include(self._path, include["path"], formats=include["format"]))
