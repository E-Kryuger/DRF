...
class PyProjectTOML:
        ...
        if self._data is None:
            if not self.path.exists():
                ...
                try:
                    ...
                    msg = f"{self._path.as_posix()} is not a valid TOML file.\n" f"{e.__class__.__name__}: {e}"
    ...
    def poetry_config(self) -> dict[str, Any]:
        try:
            ...
            raise PyProjectError(f"[tool.poetry] section not found in {self._path.as_posix()}") from e
    ...
    def is_poetry_project(self) -> bool:
        ...
        if self.path.exists():
            ...
            with suppress(KeyError):
                ...
                if project["name"] and project["version"] and not project.get("dynamic"):
                    return True
