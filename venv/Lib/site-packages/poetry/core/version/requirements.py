...
class Requirement:
    ...
    def __init__(self, requirement_string: str) -> None:
        ...
        if url:
            ...
            if parsed_url.scheme == "file":
                if urlparse.urlunparse(parsed_url) != url:
                    raise InvalidRequirementError(f'The requirement is invalid: invalid URL "{url}"')
        ...
        self.extras: Sequence[str] = [e.value for e in parsed.scan_values(lambda t: t.type == "EXTRA")]
        ...
        try:
            ...
            raise InvalidRequirementError(f'The requirement is invalid: invalid version constraint "{constraint}"')
