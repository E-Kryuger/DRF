...
class _Writer:
    ...
    def _visit(
        ...
        if isinstance(cause.conflict.cause, ConflictCauseError) and isinstance(cause.other.cause, ConflictCauseError):
        ...
        elif isinstance(cause.conflict.cause, ConflictCauseError) or isinstance(cause.other.cause, ConflictCauseError):
            derived = cause.conflict if isinstance(cause.conflict.cause, ConflictCauseError) else cause.other
            ext = cause.other if isinstance(cause.conflict.cause, ConflictCauseError) else cause.conflict
    ...
    def _is_collapsible(self, incompatibility: Incompatibility) -> bool:
        ...
        complex = cause.conflict if isinstance(cause.conflict.cause, ConflictCauseError) else cause.other

        return complex not in self._line_numbers

    def _is_single_line(self, cause: ConflictCauseError) -> bool:
        return not isinstance(cause.conflict.cause, ConflictCauseError) and not isinstance(
            cause.other.cause, ConflictCauseError
        )
