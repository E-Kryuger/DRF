...
class VersionSolver:
    ...
    def solve(self) -> SolverResult:
        ...
        self._add_incompatibility(Incompatibility([Term(root_dependency, False)], RootCauseError()))
        ...
        if packages:
            ...
            if package.is_root():
                ...
                relevant_dependencies = [
                    r for r in package.requires if not r.in_extras or r.in_extras[0] in dependency.extras
                ]
    ...
    def _choose_package_version(self) -> str | None:
        ...
        if locked is None:
            ...
            if package is None:
                ...
                self._add_incompatibility(Incompatibility([Term(dependency, True)], NoVersionsCauseError()))
