...
class Term:
        ...
        if other.is_positive():
            ...
            if self.is_positive():
                ...
                if (
                    ...
                    and self.dependency.transitive_marker == other.dependency.transitive_marker
                ):
                    return SetRelation.DISJOINT
    ...
    def _non_empty_term(self, constraint: VersionConstraint, is_positive: bool, other: Term) -> Term | None:
        ...
        if is_positive and other.is_positive():
            new_dep.transitive_marker = self.dependency.transitive_marker.union(other.dependency.transitive_marker)
