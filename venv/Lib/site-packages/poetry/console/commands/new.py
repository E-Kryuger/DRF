...
class NewCommand(InitCommand):
    ...
    arguments: ClassVar[list[Argument]] = [argument("path", "The path to create the project at.")]
    options: ClassVar[list[Option]] = [
        ...
        option(
            "src",
            None,
            "Use the src layout for the project. " "<warning>Deprecated</>: This is the default option now.",
        ),
    ...
    def handle(self) -> int:
        ...
        if self.option("src"):
            self.line_error("The <c1>--src</> option is now the default and will be removed in a future version.")
