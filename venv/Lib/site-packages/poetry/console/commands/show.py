...
class ShowCommand(GroupCommand, EnvCommand):
    ...
    arguments: ClassVar[list[Argument]] = [argument("package", "The package to inspect", optional=True)]
...
lists all packages available."""
    ...
    def _display_packages_information(self, locked_repository: Repository, root: ProjectPackage) -> int:
        ...
        width = sys.maxsize if self.option("no-truncate") else shutil.get_terminal_size().columns
