...
class CheckCommand(Command):
    ...
    def handle(self) -> int:
        ...
        project_classifiers = set(project.get("classifiers") or poetry_config.get("classifiers", []))
        ...
        if check_result["errors"] or (check_result["warnings"] and self.option("strict")):
            return_code = 1
