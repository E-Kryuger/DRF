...
class CacheClearCommand(Command):
    ...
    arguments: ClassVar[list[Argument]] = [argument("cache", description="The name of the cache to clear.")]
    options: ClassVar[list[Option]] = [option("all", description="Clear all entries in the cache.")]
