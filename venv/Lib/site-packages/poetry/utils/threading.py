...
class AtomicCachedProperty(functools.cached_property[T]):
    ...
    @overload
    def __get__(self, instance: None, owner: type[Any] | None = ...) -> AtomicCachedProperty[T]: ...
    @overload
    def __get__(self, instance: object, owner: type[Any] | None = ...) -> T: ...

    def __get__(self, instance: C | None, owner: type[Any] | None = None) -> AtomicCachedProperty[T] | T:
