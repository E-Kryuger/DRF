...
class PoetryKeyring:
    ...
    def get_password(self, name: str, username: str) -> str | None:
        ...
        try:
            ...
            raise PoetryKeyringError(f"Unable to retrieve the password for {name} from the key ring {e}")
    ...
    def is_available(cls) -> bool:
        ...
        try:
            ...
            logger.debug("Accessing keyring failed during availability check", exc_info=True)
            return False
