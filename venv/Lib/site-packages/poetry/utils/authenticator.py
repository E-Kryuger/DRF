...
class AuthenticatorRepositoryConfig:
    ...
    def get_http_credentials(self, password_manager: PasswordManager) -> HTTPAuthCredential:
...
class Authenticator:
    ...
    def _get_credentials_for_repository(self, repository: AuthenticatorRepositoryConfig) -> HTTPAuthCredential:
        ...
        if key not in self._credentials:
            self._credentials[key] = repository.get_http_credentials(password_manager=self._password_manager)
