...
class RequirementsParser:
    ...
    def parse(self, requirement: str) -> DependencySpec:
        ...
        specification = (
            self._parse_url(requirement) or self._parse_path(requirement) or self._parse_simple(requirement)
        )
    ...
    def _parse_path(self, requirement: str) -> DependencySpec | None:
        if (os.path.sep in requirement or "/" in requirement) and (
            ...
            or (Path(requirement).expanduser().exists() and Path(requirement).expanduser().is_absolute())
        ):
