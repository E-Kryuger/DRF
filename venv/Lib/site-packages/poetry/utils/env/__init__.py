...
@contextmanager
def build_environment(poetry: Poetry, env: Env | None = None, io: IO | None = None) -> Iterator[Env]:
    """
    ...
    if not env or poetry.package.build_script:
        with ephemeral_environment(
            ...
            if io:
                ...
                io.write_error_line(
                    "<b>Preparing</b> build environment with build-system requirements" f" {', '.join(requires)}"
                )
