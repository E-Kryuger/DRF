...
class EnvManager:
    ...
    def activate(self, python: str) -> Env:
        ...
        venv = venv_path / f"{self.base_env_name}-py{python_instance.minor_version.to_string()}"
    ...
    def deactivate(self) -> None:
        ...
        if self.envs_file.exists() and (minor := self.envs_file.remove_section(self.base_env_name)):
    ...
    def remove(self, python: str) -> Env:
        ...
        if python_path.is_file():
            ...
            try:
                ...
                if not self.check_env_is_for_current_project(env_name, self.base_env_name):
    ...
    def create_venv(
        ...
        if not venv.exists():
            if create_venv is False:
                self._io.write_error_line(
                    "<fg=black;bg=yellow>" "Skipping virtualenv creation, " "as specified in config file." "</>"
                )
