...
class PythonInstaller:
    ...
    def version(self) -> Version:
        try:
            ...
            return Version.from_parts(major=pyver.major, minor=pyver.minor, patch=pyver.micro)
        except ValueError:
            raise PythonDownloadNotFoundError("No suitable standalone build found for the requested Python version.")
        ...
        if bad_executables:
            raise PoetryRuntimeError(
                ...
                messages=[
                    ...
                    .wrap("info"),
                    *[ConsoleMessage(m).wrap("warning") for m in BAD_PYTHON_INSTALL_INFO],
                ],
            )
    ...
    def install(self) -> None:
        try:
            ...
            raise PythonInstallationError("Failed to download and install requested version of Python.")
